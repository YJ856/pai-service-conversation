...
"""
    ...
    environment {
        IMAGE_NAME = 'songhyunkwang/pai-service-conversation'
                    ...
                    script {
                        ...
                        withCredentials([usernamePassword(credentialsId: 'github-credentials',
                            ...
                            sh """
                                ...
                                sed -i 's|image: ${IMAGE_NAME}:.*|image: ${IMAGE_NAME}:${IMAGE_TAG}|g' k8s/base/conversation-service-deploy.yaml

                                # Commit and push
                                git add k8s/base/conversation-service-deploy.yaml
                                git commit -m "Update conversation-service image to ${IMAGE_TAG}" || echo "No changes to commit"
