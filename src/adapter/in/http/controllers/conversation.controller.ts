...
export class ConversationController {
    ...
    async recordConversation(
        ...
        const command = this.recordConversationMapper.toCommand(childProfileId, body);
    ...
    async endConversation(
        ...
        const command = this.endConversationMapper.toCommand(path, childProfileId, profileType);
    ...
    async getConversationDetail(
        ...
        const command = this.getConversationDetailMapper.toCommand(path, childProfileId);
